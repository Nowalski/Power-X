...
## Status
Version 0.1.20 is out: `PowerX.Core`, the `powerx` CLI, and the WinUI app with live dashboards, the tweak catalog and profiles, debloat, startup, services, cleanup, repair and crash insights.
